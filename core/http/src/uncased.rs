...
impl<'a> AsRef<str> for Uncased<'a> {
    #[inline(always)]
    fn as_ref(&self) -> &str {
        self.string.borrow()
    }
...
impl<'a, 'b> PartialOrd<Uncased<'b>> for Uncased<'a> {
    ...
    fn partial_cmp(&self, other: &Uncased<'b>) -> Option<Ordering> {
        <Self as AsRef<UncasedStr>>::as_ref(self).partial_cmp(other.as_ref())
    }
}

impl<'a> Ord for Uncased<'a> {
    fn cmp(&self, other: &Self) -> Ordering {
        <Self as AsRef<UncasedStr>>::as_ref(self).cmp(other.as_ref())
    }
}
...
impl<'a, 'b> PartialEq<Uncased<'b>> for Uncased<'a> {
    ...
    fn eq(&self, other: &Uncased<'b>) -> bool {
        <Self as AsRef<UncasedStr>>::as_ref(self).eq(<Uncased as AsRef<UncasedStr>>::as_ref(other))
    }
}
...
impl<'a> PartialEq<str> for Uncased<'a> {
    #[inline(always)]
    fn eq(&self, other: &str) -> bool {
        <Self as AsRef<UncasedStr>>::as_ref(self).eq(other)
    }
}
...
impl<'b> PartialEq<Uncased<'b>> for str {
    #[inline(always)]
    fn eq(&self, other: &Uncased<'b>) -> bool {
        <Uncased as AsRef<UncasedStr>>::as_ref(other).eq(self)
    }
}
...
impl<'s> Hash for Uncased<'s> {
    #[inline(always)]
    fn hash<H: Hasher>(&self, hasher: &mut H) {
        <Uncased as AsRef<UncasedStr>>::as_ref(self).hash(hasher)
    }
}
