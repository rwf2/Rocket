...
mod test {
    ...
    use super::Result;
    use super::{Config, ConfigBuilder, ConfigError, RocketConfig};
    ...
    fn test_good_secret_key() {
        ...
        check_config!(
            ...
            { default_config(Staging).secret_key("TpUiXK2d/v5DFxJnWL12suJKPExKR8h9zd/o+E7SU+0=") }
        );
        ...
        check_config!(
            ...
            { default_config(Staging).secret_key("jTyprDberFUiUFsJ3vcb1XKsYHWNBRvWAnXTlbTgGFU=") }
        );
    }
    ...
    fn test_env_override() {
        ...
        let check_value = |key: &str, val: &str, config: &Config| match key {
