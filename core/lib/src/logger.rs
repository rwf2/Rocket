...
#[doc(hidden)]
#[macro_export]
macro_rules! log_ { ($name:ident: $($args:tt)*) => { tracing::$name!(target: "_", $($args)*) }; }
#[doc(hidden)]
#[macro_export]
macro_rules! launch_info { ($($args:tt)*) => { tracing::info!(target: "launch", $($args)*) } }
#[doc(hidden)]
#[macro_export]
macro_rules! launch_info_ { ($($args:tt)*) => { tracing::info!(target: "launch_", $($args)*) } }
#[doc(hidden)]
#[macro_export]
