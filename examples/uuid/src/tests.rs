...
fn test_people() {
    test(
        "/people/7f205202-7ba1-4c39-b2fc-3e630722bf9f",
        "We found: Lacy",
    );
    test(
        "/people/4da34121-bc7d-4fc1-aee6-bf8de0795333",
        "We found: Bob",
    );
    test(
        "/people/ad962969-4e3d-4de7-ac4a-2d86d6d10839",
        "We found: George",
    );
    test(
        "/people/e18b3a5c-488f-4159-a240-2101e0da19fd",
